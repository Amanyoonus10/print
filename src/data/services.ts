...
export const servicesData: ServiceItem[] = [
  {
    ...
    features: [
      ...
      "Executive Roll-Up & Retractable Banner Stands",
      "Large-Scale Architectural Wall Decals & Murals",
      "Outdoor Event Feather & Teardrop Flags",
      "Branded Promotional Canopies & Exhibition Gazebos",
      "Retail Pillar Wraps & Floor Graphics",
      "Custom Podium & Reception Desk Branding"
    ],
    materials: [
      "High-Density Matte Vinyl & Canvas Substrates",
      "UV-Resistant Outdoor Fabrics",
      "Non-Glare Exhibition Textiles",
      "Anodized Aluminum Framing Systems",
      "Removable & Repositionable Wall Films"
    ],
    applications: [
      "Corporate Headquarters & Receptions",
      "Commercial Retail Outlets & Malls",
      "Press Conferences & Product Launches",
      "Exhibition Booths & Trade Fairs",
      "Sports Arenas & Fan Zones"
    ],
    gallery: [
      {
      ...
      {
        url: "/images/user_extracted/Page_06_Image_04.jpeg",
        title: "LuLu Hypermarket Feather Flag",
        caption: "Durable high-flutter outdoor flag with vivid colorfast inks."
      },
      {
        url: "/images/user_extracted/Page_06_Image_03.jpeg",
        title: "Pepsi Teardrop Event Flags",
        caption: "Double-sided outdoor tear-drop flags with heavy-duty ground stands."
      },
      {
  ...
  },
  {
    ...
    features: [
      ...
      "Ultra-Thin Magnetic & Snap-Frame LED Lightboxes",
      "Curved & Architectural Pillar Lightboxes",
      "High-CRI LED Illumination for Accurate Color Render",
      "Energy-Efficient Low-Voltage Power Supplies",
      "Quick-Swap Fabric Graphic System for Seasonal Campaigns"
    ],
    materials: [
      "Dye-Sublimated Backlit Stretch Fabrics",
      "Laser-Dotted Acrylic Light Guide Plates (LGP)",
      "Extruded Anodized Aluminum Profiles (Black, Silver, Custom RAL)",
      "High-Efficiency Nichia / OSRAM LED Modules",
      "Diffusing Optical Grade Polycarbonate"
    ],
    applications: [
      "Luxury Fashion & Department Stores",
      "Electronics Showrooms & Kiosks",
      "Airport Concourses & Transit Hubs",
      "Hotel Lobbies & VIP Lounges",
      "Cinema & Theater Backlit Displays"
    ],
    gallery: [
      {
  ...
  },
  {
    ...
    number: "03",
    title: "EVENTS",
    subtitle: "Complete visual storytelling and large-format staging for tournaments, summits, and galas.",
    ...
    features: [
      ...
      "Stage Sets, Fascias & Podium Dressing",
      "Tournament Directional & Wayfinding Signage",
      "Interactive Fan-Zone Photo Installations",
      "Mascot Backdrops & 3D Props Fabrication",
      "Rapid Turnaround & On-Site Installation Teams"
    ],
    materials: [
      "Heavy-Duty Flame Retardant PVC Banners",
      "Anti-Glare Media Fabric Backdrops",
      "Reinforced Steel & Aluminum Trussing",
      "Direct-Print Foam Board & Foam PVC (Forex)",
      "High-Traffic Non-Slip Floor Decals"
    ],
    applications: [
      "International Sports Championships (Basketball, Football, Athletics)",
      "Global Innovation Summits & Medical Conferences",
      "Government Ceremonies & National Day Celebrations",
      "Corporate Annual Galas & Award Evenings",
      "Public Festivals & Fan Experience Zones"
    ],
    gallery: [
      {
  ...
  },
  {
    ...
    features: [
      ...
      "Tri-Fold, Gatefold & Multi-Page Brochures",
      "Spiral-Bound & Hardcover Desk Calendars",
      "Corporate Stationery Suites (Letterheads, Envelopes, Business Cards)",
      "Luxury Foiling, Embossing, Debossing & Spot UV",
      "Die-Cutting & Custom Structural Packaging"
    ],
    materials: [
      "FSC-Certified Fine Coated & Uncoated Stocks (80gsm - 400gsm)",
      "Textured Cotton & Linen Specialty Papers",
      "Metallic & Holographic Hot Stamping Foils",
      "Soft-Touch, Matte, and Gloss Thermal Laminates",
      "Eco-Friendly Vegetable & Soy-Based Inks"
    ],
    applications: [
      "Corporate Governance & Financial Reports",
      "Real Estate Development Portfolios",
      "Luxury Hospitality Menus & Collateral",
      "Product Catalogs & Lookbooks",
      "Direct Mail & Executive Invitations"
    ],
    gallery: [
      {
      ...
      },
      {
        ...
        title: "Custom Branded Envelopes & Cards",
        caption: "Corporate correspondence set with embossed brand logos."
      }
    ]
  },
  {
    ...
    number: "05",
    title: "GIFT ITEMS",
    subtitle: "Curated corporate gift sets, branded executive merchandise, and luxury presentation packaging.",
    shortDescription: "VIP executive boxes, smart thermo flasks, leather notebooks, tech accessories, and trophies.",
    fullDescription: "Leave a lasting impression with customized executive gift items and branded corporate merchandise. We design, source, engrave, and assemble VIP gift boxes, thermo-insulated drinkware, leatherette notebooks with engraved metal pens, wireless power banks, universal travel adapters, custom medals, and luxury tote bags.",
    heroImage: "/images/user_extracted/Page_10_Image_02.jpeg",
    previewImage: "/images/user_extracted/Page_10_Image_13.jpeg",
    features: [
      "Bespoke VIP Gift Boxes with Custom Foam Inserts",
      "Laser-Engraved Smart Digital Temperature Thermos Bottles",
      "Embossed Leather Planners, Notebooks & Stylus Pen Sets",
      "Branded Qi Wireless Chargers & Fast Powerbanks",
      "Universal World Travel Adapters in Hard Cases",
      "Premium Eco-Friendly Canvas & Jute Tote Bags",
      "Custom Cast Medals, Ribbons & Commemorative Badges"
    ],
    materials: [
      "Rigid Hardbound Presentation Boxes with Magnetic Closures",
      "Food-Grade Double-Wall Stainless Steel (SUS 304/316)",
      "PU Leatherette, Vegan Leather, and Velvet Pouches",
      "Organic Heavyweight Cotton Canvas & Natural Jute",
      "Zinc Alloy, Brushed Brass, and Antique Bronze Plating"
    ],
    applications: [
      "VIP Delegations & Government Protocol Gifts",
      "Employee Welcome & Milestone Recognition Kits",
      "Corporate Ramadan & National Day Gift Sets",
      "Conference Attendee & Speaker Keepsakes",
      "High-Value Client Appreciation Packages"
    ],
    gallery: [
      {
      ...
      },
      {
        ...
        title: "Doha Bank Digital Thermo Flask",
        caption: "Matte black stainless steel bottle with LED temperature readout."
      },
      {
      ...
      },
      {
        ...
        title: "Marriott Hotels Amenity Pouches",
        caption: "Tailored canvas cosmetic & amenity bags with embroidered insignia."
      },
      {
  ...
  },
  {
    ...
    features: [
      ...
      "3D Dimensional Wall Lettering & Corporate Logos",
      "Executive Triangular Desk Nameplates & Door Signs",
      "Architectural Wayfinding & Multi-Floor Directories",
      "Compliant Industrial & Building Safety Signage (Fire, Exit, Caution)",
      "Clear Acrylic Brochure Holders & Product Pedestals",
      "Diamond Edge Polishing & Flame Finishing"
    ],
    materials: [
      "Cast Acrylic Sheets (Clear, Frosted, Opal, Solid Colors, 2mm - 30mm)",
      "Brushed Gold, Silver & Rose-Gold Metallic Acrylic Laminates",
      "Solid Optical Crystal & Polished Black Marble Bases",
      "Stainless Steel Standoff Spacers & Wall Mounts",
      "Direct UV Scratch-Resistant Inks & Second-Surface Printing"
    ],
    applications: [
      "Corporate Excellence Awards & Retirement Trophies",
      "Luxury Hotel Room Numbering & Directional Systems",
      "Office Park & Commercial Tower Floor Directories",
      "Industrial Plants & Commercial Safety Signage",
      "Boutique Countertop Product Displays"
    ],
    gallery: [
      {
        url: "/images/user_extracted/Page_12_Image_01.jpeg",
        title: "Distinguished Service Star Award",
        caption: "Multi-layered black and clear acrylic trophy with metallic star accent."
      },
      {
      ...
      },
      {
        ...
        title: "Architectural Number Plaque 48",
  ...
  {
    id: "uniforms-sportswear",
    slug: "uniforms-sportswear",
    number: "07",
    title: "UNIFORMS & SPORTS WEAR",
    subtitle: "High-performance team apparel, tailored industrial workwear, and branded corporate clothing.",
    shortDescription: "Reflective safety coveralls, embroidered school and hospitality polos, sublimated sports kits, and caps.",
    fullDescription: "Outfit your workforce and athletic teams in premium, durable, and stylish branded apparel. We provide heavy-duty industrial coveralls with certified 3M reflective tape, embroidered corporate and school polo shirts, moisture-wicking full-sublimation sports jerseys, tailored aprons, hospitality uniforms, and custom headwear.",
    heroImage: "/images/user_extracted/Page_13_Image_03.jpeg",
    previewImage: "/images/user_extracted/Page_13_Image_04.jpeg",
    features: [
      "Heavy-Duty Industrial Safety Boiler Suits & Overalls",
      "High-Visibility Reflective 3M Safety Striping",
      "Executive Pique Polo Shirts with Multi-Color Embroidery",
      "Full-Dye Sublimation Sports Jerseys & Team Kits",
      "Custom Branded Caps, Visors & Athletic Headbands",
      "Hospitality & Retail Staff Aprons with Pocket Utility",
      "Durable Colorfast Inks & Industrial-Wash Resistant Fabrics"
    ],
    materials: [
      "Heavy-Duty Poly-Cotton Drill & Flame-Resistant Cotton",
      "100% Breathable Combed Cotton Pique (200gsm - 240gsm)",
      "High-Performance Quick-Dry Polyester Interlock",
      "Certified 3M Scotchlite Retro-Reflective Bands",
      "High-Tensile Madeira Embroidery Threads"
    ],
    applications: [
      "Oil & Gas, Construction & Engineering Teams",
      "Private Academies & International Schools",
      "Hotels, Restaurants, Supermarkets & Retail Chains",
      "Youth & Professional Sports Leagues (Basketball, Football)",
      "Corporate Sports Tournaments & Charity Marathons"
    ],
    gallery: [
      {
      ...
      {
        url: "/images/user_extracted/Page_13_Image_04.jpeg",
        title: "Qatar Academy Embroidered Polo",
        caption: "White pique polo shirt with fine Qatar Foundation crest embroidery."
      },
      {
  ...
  },
  {
    ...
    subtitle: "Mobile visual powerhouses engineered with high-durability cast vinyl and seamless contours.",
    shortDescription: "Full commercial fleet wraps, public transit bus wraps, utility pickup graphics, and delivery vans.",
    fullDescription: "Turn your transport and commercial fleet into 24/7 mobile billboards. We deliver full wraps, partial wraps, and precision contour-cut decals for public transit buses, commercial vans, utility pickup trucks, luxury executive shuttles, and delivery fleets. Utilizing premium cast vinyls and UV-protective over-laminates, our wraps withstand Qatar's extreme climate while preserving vehicle paint.",
    heroImage: "/images/user_extracted/Page_14_Image_02.jpeg",
    previewImage: "/images/user_extracted/Page_14_Image_01.jpeg",
    features: [
      "Full Vehicle Wraps for Buses, Vans, Pickups & SUVs",
      "Partial Wraps & Corporate Fleet Decal Branding",
      "One-Way Vision Perforated Window Graphics",
      "High-Resolution Wide-Format Eco-Solvent & UV Inks",
      "Heat-Conformed Application for Deep Body Channels & Curves",
      "Paint Protection & Clean Removal Without Adhesive Residue",
      "Climate-Tested Durability Against Sun, Heat & Sand"
    ],
    materials: [
      "Premium Cast Wrapping Vinyls (3M / Avery Dennison)",
      "Air-Release Micro-Channel Adhesive Technology (Bubble-Free)",
      "Cast Gloss & Matte UV Protective Over-Laminates",
      "50/50 Perforated Window Vision Vinyls",
      "Edge-Sealing Tape & Precision Knifeless Cut Systems"
    ],
    applications: [
      "Public Transit & Electric City Buses",
      "Hospital & Hotel Hospitality Passenger Vans",
      "Logistics, Courier & Food Delivery Fleets",
      "Energy, Contracting & Utility Pickup Trucks",
      "Healthcare, Medical & Dental Mobile Clinics"
    ],
    gallery: [
      {
        url: "/images/user_extracted/Page_14_Image_02.jpeg",
        title: "Zero-Emission Electric City Bus Wrap",
        caption: "Full exterior 12m wrap with perforated window vision films."
      },
      {
        url: "/images/user_extracted/Page_14_Image_01.jpeg",
        title: "Ping Hospitality Passenger Van",
        caption: "High-contrast two-tone commercial livery on Toyota HiAce passenger van."
      },
      {
