              ...
              <div className="p-6 sm:p-8 flex flex-col gap-5 flex-grow justify-between">
                ...
                <div className="pt-6 border-t border-[#EDE8DE] flex items-center justify-between">
                  <Link
                    ...
                    className="inline-flex items-center gap-1.5 text-xs font-mono font-bold text-[#49C1DA] hover:text-[#B8955A] uppercase tracking-wider group"
                  >
                  ...
                  <button
                    ...
                    className="px-4 py-2 rounded-full bg-[#EDE8DE] hover:bg-[#49C1DA] text-[#171717] hover:text-white border border-[#EDE8DE] font-mono text-xs uppercase font-semibold transition-colors cursor-pointer"
                  >
                    Quote
                  </button>
                </div>
