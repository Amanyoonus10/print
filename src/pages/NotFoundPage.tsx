...
export const NotFoundPage: React.FC = () => {
  return (
    <div className="min-h-[80vh] flex flex-col items-center justify-center text-center px-4 bg-[#F7F4EE]">
      <span className="font-mono text-base font-bold text-[#0284C7] mb-2">
        ERROR 404
      </span>
      ...
      <div className="mt-8 flex items-center gap-4">
        <Link
          to="/"
          className="px-6 py-3.5 rounded-full bg-[#0284C7] hover:bg-[#0369A1] text-white font-display font-bold text-xs uppercase tracking-wider flex items-center gap-2 shadow-[0_4px_20px_rgba(2,132,199,0.35)]"
        >
