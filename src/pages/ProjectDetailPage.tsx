  ...
  return (
    <div className="w-full min-h-screen bg-[#F7F4EE] pt-28 pb-20">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        <Link
          to="/work"
          className="inline-flex items-center gap-2 text-xs font-mono font-bold text-[#0284C7] hover:text-[#B8955A] uppercase tracking-wider"
        >
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-12 border-b border-[#EDE8DE]">
        ...
        <div className="max-w-4xl flex flex-col gap-6">
          <div className="flex flex-wrap items-center gap-3">
            <span className="font-mono text-xs font-bold text-[#0284C7] px-3 py-1.5 rounded-full bg-[#0284C7]/10 border border-[#0284C7]/25">
              {project.category}
            </span>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="mt-16 text-center">
          <button
            ...
            className="px-8 py-4 rounded-full bg-[#0284C7] hover:bg-[#0369A1] text-white font-display font-bold text-xs uppercase tracking-wider inline-flex items-center gap-2 shadow-[0_4px_20px_rgba(2,132,199,0.35)] cursor-pointer hover:scale-105 transition-all"
          >
