      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-12">
        <div className="p-8 sm:p-12 rounded-3xl bg-white border border-[#EDE8DE] flex flex-col md:flex-row items-center justify-between gap-8 text-center md:text-left shadow-xl">
          ...
          <button
            ...
            className="px-8 py-4 rounded-full bg-[#0284C7] hover:bg-[#0369A1] text-white font-display font-bold text-xs uppercase tracking-wider flex items-center gap-2 shadow-[0_4px_25px_rgba(2,132,199,0.35)] shrink-0 cursor-pointer hover:scale-105 transition-all"
          >
