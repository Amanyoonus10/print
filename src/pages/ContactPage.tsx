            ...
            <div className="p-8 rounded-3xl bg-white border border-[#EDE8DE] flex flex-col gap-6 shadow-xs">
              ...
              <div className="flex flex-col gap-5 text-sm text-[#555555]">
                ...
                <div className="flex items-start gap-4">
                  <div className="w-10 h-10 rounded-xl bg-[#49C1DA]/10 border border-[#49C1DA]/25 flex items-center justify-center text-[#49C1DA] shrink-0">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a href="tel:+97441423938" className="font-mono font-bold text-[#171717] hover:text-[#49C1DA] transition-colors">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a href={`mailto:${companyData.contact.email}`} className="font-mono text-[#171717] hover:text-[#49C1DA] transition-colors font-medium">
            ...
            <div className="p-8 sm:p-10 rounded-3xl bg-white border border-[#EDE8DE] shadow-xl">
              ...
              {!isSubmitted ? (
                <form onSubmit={handleSubmit} className="flex flex-col gap-6">
                  ...
                  <button
                    type="submit"
                    className="w-full py-4 rounded-xl bg-[#49C1DA] hover:bg-[#32AEC8] text-white font-display font-bold text-xs uppercase tracking-wider flex items-center justify-center gap-2 shadow-[0_4px_25px_rgba(73,193,218,0.35)] transition-all cursor-pointer hover:scale-102"
                  >
