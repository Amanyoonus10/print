      ...
      {services.map((service, index) => {
        ...
        return (
          ...
          >
            ...
            <div className={`absolute top-1/2 ${isEven ? 'left-0' : 'right-0'} -translate-y-1/2 w-96 h-96 bg-[#0084C8]/5 rounded-full blur-3xl pointer-events-none`} />
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
                ...
                >
                  ...
                  {/* Subtitle / Statement */}
                  <p className="text-lg md:text-xl font-medium text-[#0084C8] leading-snug">
                    “{service.subtitle}”
                  </p>
                  ...
                  <div className="flex flex-wrap items-center gap-4 pt-4">
                    {onOpenQuoteModal ? (
                      <button
                        ...
                        className="px-6 py-3.5 rounded-full bg-[#0084C8] hover:bg-[#006EAA] text-white font-display font-bold text-xs uppercase tracking-wider flex items-center gap-2 transition-all duration-300 shadow-[0_4px_20px_rgba(0,132,200,0.3)] cursor-pointer group hover:scale-102"
                      >
                      ...
                      <a
                        ...
                        className="px-6 py-3.5 rounded-full bg-[#0084C8] hover:bg-[#006EAA] text-white font-display font-bold text-xs uppercase tracking-wider flex items-center gap-2 transition-all duration-300 shadow-[0_4px_20px_rgba(0,132,200,0.3)]"
                      >
                        <span>Inquire {service.title}</span>
