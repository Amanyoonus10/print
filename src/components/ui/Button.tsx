...
export const Button: React.FC<ButtonProps> = ({
  ...
  const variantStyles = {
    primary: "bg-[#49C1DA] text-white hover:bg-[#32AEC8] hover:shadow-[0_4px_20px_rgba(73,193,218,0.35)] active:scale-[0.98]",
    secondary: "bg-[#EDE8DE] text-[#171717] hover:bg-white hover:border-[#EDE8DE] border border-[#EDE8DE] active:scale-[0.98]",
    outline: "bg-transparent text-[#171717] border border-[#EDE8DE] hover:border-[#49C1DA] hover:text-[#49C1DA] hover:bg-[#49C1DA]/5 active:scale-[0.98]",
