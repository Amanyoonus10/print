...
export const Button: React.FC<ButtonProps> = ({
  ...
  const variantStyles = {
    primary: "bg-[#0084C8] text-white hover:bg-[#006EAA] hover:shadow-[0_4px_20px_rgba(0,132,200,0.35)] active:scale-[0.98]",
    secondary: "bg-[#EDE8DE] text-[#171717] hover:bg-white hover:border-[#EDE8DE] border border-[#EDE8DE] active:scale-[0.98]",
    outline: "bg-transparent text-[#171717] border border-[#EDE8DE] hover:border-[#0084C8] hover:text-[#0084C8] hover:bg-[#0084C8]/5 active:scale-[0.98]",
