    ...
    >
      ...
      >
        ...
        <div className="absolute bottom-5 left-5 right-5 z-10 flex items-end justify-between">
          ...
          <div className="w-10 h-10 rounded-full bg-[#49C1DA] text-white flex items-center justify-center transition-all duration-300 group-hover:scale-110 shadow-md shrink-0 ml-3">
